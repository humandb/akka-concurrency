...
// The duration package extends Ints with some timing functionality
...
class Altimeter extends Actor with ActorLogging
  ...
  // As time passes, we need to change the altitude based o the time passed. The lastTick allows us to figure
